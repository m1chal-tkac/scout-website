...
export interface ApiDruzinaDruzina extends Schema.CollectionType {
...
export interface ApiJedenVedouciJedenVedouci extends Schema.CollectionType {
  collectionName: 'vice_vedouci';
  info: {
    singularName: 'jeden-vedouci';
    pluralName: 'vice-vedouci';
    displayName: 'Vedouc\u00ED';
    description: '';
  };
  options: {
...
export interface ApiNovinkaNovinka extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Nazev: Attribute.String & Attribute.Required;
    Url: Attribute.String & Attribute.Required & Attribute.Unique;
    Popis: Attribute.Text & Attribute.Required;
    Text: Attribute.Blocks & Attribute.Required;
    oddily: Attribute.Relation<
      'api::novinka.novinka',
      'manyToMany',
      'api::oddil.oddil'
    >;
...
export interface ApiOddilOddil extends Schema.CollectionType {
...
export interface ApiStrediskoStredisko extends Schema.SingleType {
  collectionName: 'strediska';
  info: {
    singularName: 'stredisko';
    pluralName: 'strediska';
    displayName: 'St\u0159edisko';
    description: '';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    Nazev: Attribute.String & Attribute.Required;
    CelyNazev: Attribute.String & Attribute.Required;
    Sidlo: Attribute.String & Attribute.Required;
...
export interface ApiUvodniStrankaUvodniStranka extends Schema.SingleType {
  collectionName: 'uvodni_stranky';
  info: {
    singularName: 'uvodni-stranka';
    pluralName: 'uvodni-stranky';
    displayName: '\u00DAvodn\u00ED str\u00E1nka';
    description: '';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::uvodni-stranka.uvodni-stranka',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::druzina.druzina': ApiDruzinaDruzina;
